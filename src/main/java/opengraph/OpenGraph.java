/*
 * Copyright (c) 2019-2019 Amnesia Network Inc. - All Rights Reserved
...
public class OpenGraph {
    ...
    /**
     * Fetch the open graph representation from a website
     *
    ...
    public OpenGraph(String url, boolean ignoreSpecErrors) throws java.io.IOException, Exception {
        ...
        siteConnection.setRequestProperty("User-Agent", "facebookexternalhit/1.1"); // Youtube doesn't serve meta tags unless this is the user agent
        ...
        while ((inputLine = dis.readLine()) != null) {
            if (!url.contains("youtube.com") && inputLine.contains("</head>")) // Youtube places it in the body smh
            {
